...
namespace Clippers_Salon.Controllers
{
    ...
    public class ProductAdminController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Price,Image,Vendor,Description")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Price,Image,Vendor,Description")] Product product)
        {
            if (ModelState.IsValid)
            {
